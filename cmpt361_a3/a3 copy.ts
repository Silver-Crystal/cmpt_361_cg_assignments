...
class Rasterizer extends parentRetadedRasterizer { // name suggested by an intelligent friend :pray:, gotta do what i gotta do
  ...
  interpolateColor (c1: any[], c2: any[], t: number) {
    return[
      c1[0] + t * (c2[0] - c1[0]), 
      c1[1] + t * (c2[1] - c1[1]),
      c1[2] + t * (c2[2] - c1[2])
  ...
  drawLine (v1: [any, any, [any, any, any]], v2: [any, any, [any, any, any]]) {
  ...
  pointIsInsideOrOnEdge (line: any[],point: [any, any]) {
  ...
  pointIsInsideTriangle (vertex1: any,vertex2: any,vertex3: any,point: tuple[]) {
  ...
  drawTriangle (v1: [any, any, [any, any, any]], v2: [any, any, [any, any, any]], v3: [any, any, [any, any, any]]) {
    const [x1, y1, [r1, g1, b1]] = v1;
    const [x2, y2, [r2, g2, b2]] = v2;
